...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is WZPAlertController_Category
                   DESC

  s.homepage     = "https://github.com/v5xiaopeng/WZPAlertController_Category"
  ...
  s.source       = { :git => "https://github.com/v5xiaopeng/WZPAlertController_Category.git", :tag => s.version.to_s }
